 function intro() {
  ...
  var result = "Your username is " + username + " and you are " + age + " years old. You created the " + guild + " guild. Your stats are " + strength + " points for strength  and " + IQ + " points for IQ."
